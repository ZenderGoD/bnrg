...
export default function Kids() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        // Fetch products from "kids-collection"
        const kidsProducts = await getProductsByCollection('kids-collection', 20);
    ...
    <div className="min-h-screen pt-16">
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-center h-full py-12">
          ...
          <div className="text-center text-white mb-8">
            ...
            >
              Where every step is an adventure and comfort meets play
            </motion.p>
          </div>
      ...
      >
        <ProductGrid
          ...
          isLoading={isLoading}
          title="Kids' Sneakers"
          subtitle="Perfect fit for growing feet, designed for endless adventures"
        />
      </motion.div>
    </div>
  );
