...
export default function Men() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        // Fetch products from "mens-collection"
        const menProducts = await getProductsByCollection('mens-collection', 20);
  ...
  return (
    <div className="min-h-screen pt-16">
      ...
      <motion.section
        className="relative h-[50vh] bg-gradient-primary overflow-hidden"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-center h-full py-12">
          ...
          <div className="text-center text-white mb-8">
            ...
            >
              Experience the perfect fusion of performance and style
            </motion.p>
          </div>
      ...
      >
        <ProductGrid
          ...
          subtitle="Discover cutting-edge designs and premium craftsmanship in every step"
        />
      </motion.div>
    </div>
  );
